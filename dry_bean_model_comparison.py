# -*- coding: utf-8 -*-
"""
Dry Bean Classification: A Comparative Study of Machine Learning Models 🚀
-------------------------------------------------------------------------
Project Overview:
This project focuses on categorizing seven different types of dry beans based 
on their morphological features (Area, Perimeter, Compactness, etc.). Using 
various classification algorithms, the performance and stability of each model 
were evaluated to find the most efficient solution for biological seed classification.

Key Features:
* Comparative Analysis: SVM (RBF Kernel), Random Forest, Naive Bayes, and KNN.
* Data Integrity: Implementation of "Scaling after Splitting" to prevent Data Leakage.
* Robustness: Verified via 5-Fold Cross-Validation.
"""
